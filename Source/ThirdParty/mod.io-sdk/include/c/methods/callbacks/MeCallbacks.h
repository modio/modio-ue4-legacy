...
struct GetUserRatingsParams
{
  void* object;
  std::string url;
  bool is_cache;
  void (*callback)(void* object, ModioResponse response, ModioRating ratings[], u32 ratings_size);
};
...
extern std::map< u32, GetUserRatingsParams* > get_user_ratings_callbacks;
