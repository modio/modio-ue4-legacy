...
UCallbackProxy_GetUserMods *UCallbackProxy_GetUserMods::GetUserMods(UObject *WorldContext, TEnumAsByte<EModioFilterType> FilterType, TArray<FString> ModTags, int32 Limit, int32 Offset)
{
...
void UCallbackProxy_GetUserMods::Activate()
{
  ...
  if( Modio.IsValid() )
  {
    Modio->GetUserMods( this->FilterType, this->ModTags, this->Limit, this->Offset, FModioModArrayDelegate::CreateUObject( this, &UCallbackProxy_GetUserMods::OnGetUserModsDelegate ) );
  }
  else
  {
