...
void FModioModule::StartupModule()
{
  ...
  ModioImp = FModioSubsystem::Create(Settings->RootDirectory, Settings->GameId, Settings->ApiKey, Settings->bIsLiveEnvironment, Settings->bInstallOnModDownload, Settings->bRetrieveModsFromOtherGames);
